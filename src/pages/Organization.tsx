...
// //       GST_No: companyManagement.gstNumber,
// //       PAN_No: companyManagement.panNumber,
...
// //         Object.keys(companyManagement).forEach((key) => {
// //           companyManagement[key] = "";
// //         });
// //       }
// //     } catch (error) {
...
// //         setCompanies(response?.data?.data); // assuming response is like { companies: [...] }
// //       }
// //     } catch (error) {
...
// //       gstNumber: company.GST_No || "",
// //       panNumber: company.PAN_No || "",
...
// //                 value={companyManagement.gstNumber}
...
// //                 value={companyManagement.panNumber}
// //                 onChange={handleChange}
// //               />
// //             </div>
// //           </>
...
// //               id="note"
// //               name="note"
// //               placeholder="Enter any state-specific note..."
// //               onChange={handleChange}
// //             />
// //           </div>
// //         );
...
// //                     className="h-6 text-xs flex-1"
// //                     value={companyManagement.Master_Id}
// //                     onChange={handleChange}
// //                   />
// //                 </div>
// //                 <div className="flex items-center gap-2">
...
// //                     className="h-6 text-xs flex-1"
// //                     value={companyManagement.Alter_Id}
// //                     onChange={handleChange}
// //                   />
// //                 </div>
// //                 <div className="flex items-center gap-2">
...
// //                     placeholder="Country"
// //                     className="h-6 text-xs flex-1"
// //                     value={companyManagement.country}
// //                     onChange={handleChange}
// //                   />
// //                 </div>
// //                 <div className="flex items-center gap-2">
...
// //                 <th className="px-4 py-2 border-b">GST number</th>
// //                 <th className="px-4 py-2 border-b">Website</th>
// //                 <th className="px-4 py-2 border-b">Pan Number</th>
...
// //                   <td className="px-4 py-2 border-b">{company.GST_No}</td>
// //                   <td className="px-4 py-2 border-b">{company.Website}</td>
// //                   <td className="px-4 py-2 border-b">{company.PAN_No}</td>
...
//       Master_Id: companyManagement.Master_Id,
//       Alter_Id: companyManagement.Alter_Id,
//     };
...
//       booksBeginning: company.Books_Beginning || "",
//     });
//     setModalopen(true);
//     setManagementType("Update");
//   };
              ...
              <div className="flex-1">
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <select className="hihi h-6 text-xs flex-1 " onChange={(e) => {
