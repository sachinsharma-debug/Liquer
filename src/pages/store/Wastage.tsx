...
export default function Wastage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <Dialog open={openMainDialog} onOpenChange={setOpenMainDialog}>
          <DialogTrigger asChild>
            <Button onClick={() => setOpenMainDialog(true)}>Add Wastage</Button>
          </DialogTrigger>
          ...
          <DialogContent className="sm:max-w-[900px]">
            ...
            <div className="grid grid-cols-3 gap-4 py-4 border-b border-t">
              <div className="flex items-center gap-2">
                <Label htmlFor="poNumber" className="text-xs w-32">Wastage No</Label>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Wastage List</CardTitle>
        </CardHeader>
        <CardContent>
